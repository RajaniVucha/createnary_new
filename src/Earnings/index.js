...
function Earnings() {
  ...
  const submitHandler = (event) => {
    ...
    console.log(formData.rangeProducts);
    ...
    const monthlyEarnings = formData.rangeProducts * 1000;
    ...
    <div className="earning-container">
      ...
      <div className="earning-form">
        <form onSubmit={submitHandler} className="earning-content">
          <div>
            <label htmlFor="influencerType" className="earning-para">
          ...
          <div>
            <label htmlFor="followers" className="earning-para">
          ...
          <div>
            <label htmlFor="products" className="earning-para">
              How many products dou you list monthly?
            </label>
            <div>
              <input
                type="range"
